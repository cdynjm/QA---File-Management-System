...
<style>
    ...
    .active-dashboard {
        ...
        <div class="body">
            ...
            <span class="recent-uploads" id='exclude-header'><i class="fa-solid fa-newspaper"></i> All Uploads</span>
            <span class="total-articles" id='exclude-header'><i class="fa-solid fa-box-open"></i> Total Files: <?php echo $COUNT_ARTICLES; ?></span>
            <table>
                <tr>
                    <th width='5%'>No.</th>
    ...
    <div class="dashboard-menu-1">
            <span class="dashboard-text"><?php print $COUNT_ARTICLES; ?></span>
            <span class="dashboard-icon1"><i class="fa-solid fa-file-lines"></i></span>
            <span class="dashboard-label"><p>Total Files</p></span>
        </div>

        <div class="dashboard-menu-2">
            <span class="dashboard-text"><?php print $COUNT_FOLDERS; ?></span>
            <span class="dashboard-icon2"><i class="fa-solid fa-folder-open"></i></span>
            <span class="dashboard-label"><p>Total Folders</p></span>
        </div>
